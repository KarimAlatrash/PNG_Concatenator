...
/*   printf("setup global_curl\n");
 */}

void curl_global_teardown() {
    curl_global_cleanup();
/*     printf("tore down global_curl\n");
 */}

CURL *curl_setup_fetch_file(char* serv_url) {
/*     printf("starting curl_setup_fetch_file\n");
 */    CURL *curl_handle;
    char url[256];
...
/* printf("finishing curl_setup_fetch_file\n");
 */    return curl_handle;
}

void curl_teardown_fetch_file(CURL *curl_handle) {
    curl_easy_cleanup(curl_handle);
/*     printf("finished curl_teardown_fetch_file\n");
 */}
int curl_fetch_file (RECV_BUF *recv_buf, CURL *curl_handle) {
/*         printf("started curl_fetch_file\n");
 */
  CURLcode res;
  char fname[256];
  pid_t pid =getpid();
...
/*         printf("finished curl_fetch_file\n");
 */
  return 0;
}
